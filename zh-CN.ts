export const ZH_CN = {
    ...
    SwissUpgrade: "瑞士幣升級",
    SwissUpgradeDesc: "这个瑞士币升级是永久性的，如果您从新城市开始，此项升级将会保留",
    SwissBoost: "瑞士加成(Swiss Boost)",
    SwissBoostDesc: "瑞士加成(Swiss Boost) 只會影响您当前的游戏场景,如果你在一个新城市开始,它(Swiss Boost)将会重置",
    ...
    SwissBoostCostDividerDesc: "降低 Swiss Boost 的升级成本 - 仅适用于乘数/除数升级",
